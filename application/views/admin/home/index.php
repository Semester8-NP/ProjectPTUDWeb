...
<div class="wrapper">
    ...
    <div class="widgets">
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="<?php echo assets_url('admin/') ?>images/icons/dark/money.png" class="titleIcon" />
                    <h6>Doanh số</h6>
                </div>
        ...
        <div class="oneTwo">
            <div class="widget">
                <div class="title">
                    <img src="<?php echo assets_url('admin/') ?>images/icons/dark/users.png" class="titleIcon" />
